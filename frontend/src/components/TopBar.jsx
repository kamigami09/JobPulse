...
import {
  Plus, FileText, Download, Settings, LogOut, ChevronDown,
} from 'lucide-react'
...
export default function TopBar({
  onAddJob, onResumes, statusFilter, onStatusFilter,
  username, onLogout, onSettings,
}) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-zinc-800/80 bg-zinc-950/90 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-screen-2xl items-center gap-2 px-6">

        {/* Logo */}
        <div className="flex shrink-0 items-center gap-2.5 mr-3">
        ...
        <div className="flex items-center gap-2">
          {username && (
            <div className="h-6 w-6 rounded-full bg-indigo-600/20 border border-indigo-500/30 flex items-center justify-center select-none" title={username}>
